...
-- Module  Version: 5.6
--C:\lscc_64\diamond\3.3_x64\ispfpga\bin\nt64\scuba.exe -w -n ecp5_pll -lang vhdl -synth synplify -bus_exp 7 -bb -arch sa5p00m -type pll -fin 250 -fclkop 250 -fclkop_tol 0.0 -phase_cntl STATIC -rst -lock -fb_mode 1 -fdc C:/Temp/gammatest/Clarity/coregenvhd/ecp5_pll/ecp5_pll.fdc 

-- Mon Dec 15 15:48:11 2014
...
entity ecp5_pll is
 ...
 attribute dont_touch of ecp5_pll : entity is true;
end ecp5_pll;

architecture Structure of ecp5_pll is
    ...
    attribute FREQUENCY_PIN_CLKI of PLLInst_0 : label is "250.000000";
    attribute ICP_CURRENT of PLLInst_0 : label is "11";
    attribute LPF_RESISTOR of PLLInst_0 : label is "36";
...
begin
    ...
    PLLInst_0: EHXPLLL
        ...
        CLKOS2_DIV=>  1, CLKOS_DIV=>  1, CLKOP_DIV=>  2, CLKFB_DIV=>  1, 
