...
`timescale 1 ns / 1 ps
module tb;
    reg [11:0] WrAddress = 12'b0;
    reg [11:0] RdAddress = 12'b0;
    reg [11:0] Data = 12'b0;
    reg WE = 0;
    reg RdClock = 0;
    reg RdClockEn = 0;
    ...
    debayer_dpram u1 (.WrAddress(WrAddress), .RdAddress(RdAddress), .Data(Data), 
    ...
    begin
      ...
      #100;
      @(Reset == 1'b0);
      for (i1 = 0; i1 < 8198; i1 = i1 + 1) begin
        @(posedge WrClock);
    ...
    begin
      ...
      #100;
      @(Reset == 1'b0);
      for (i2 = 0; i2 < 8198; i2 = i2 + 1) begin
        @(posedge RdClock);
    ...
    begin
      ...
      #100;
      @(Reset == 1'b0);
      for (i3 = 0; i3 < 4099; i3 = i3 + 1) begin
        @(posedge WrClock);
        #1  Data <= Data + 1'b1;
      end
    end
    ...
    begin
       WE <= 1'b0;
      @(Reset == 1'b0);
      for (i4 = 0; i4 < 4099; i4 = i4 + 1) begin
        @(posedge WrClock);
        #1  WE <= 1'b1;
      end
       WE <= 1'b0;
